...
namespace testnet.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        public TokenController(IConfiguration config, TestnetContext context)
        {
        ...
        private UserInfo GetUser(string email, string password)
        {
            ...
            return _context.UserInfo.Find(Query.And(Query.EQ("Email", email), Query.EQ("Password", password))).First();
        }
    }
}
